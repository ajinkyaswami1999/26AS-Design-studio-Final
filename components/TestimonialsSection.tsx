      ...
      setTestimonials([
        {
          ...
          testimonial_text: 'Working with 26AS was an absolute pleasure. Their attention to detail and innovative approach transformed our vision into reality.',
          rating: 5,
          active: true,
        ...
        },
        {
          ...
          testimonial_text: 'The team delivered exceptional results that exceeded our expectations. Highly recommend their services.',
          rating: 5,
          active: true,
          created_at: new Date().toISOString(),
          updated_at: new Date().toISOString()
        ...
        <div className="relative h-64 overflow-hidden">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div>
                <h4 className="font-medium text-lg">{testimonial.client_name}</h4>
